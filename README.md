...
* The middle row has green LEDs and work like a switcher (pressing one of them turns on the LED, pressing a different button turns off the first one and turns on the new one). This was meant to work as a scene switcher.
